...
// $insert polymorphicSpecializations
    template <>
    struct TagOf<pair <string, string>>
    {
        static Tag__ const tag = Tag__::PARAMETER_DECLARATION;
    };
    ...
    template <>
    struct TagOf<vector < string >>
    {
        static Tag__ const tag = Tag__::DECLARATOR_LIST;
    };
    ...
    template <>
    struct TagOf<vector < pair <string, string> >>
    {
        static Tag__ const tag = Tag__::PARAMETER_LIST;
    };
    ...
    {
        static Tag__ const tag = Tag__::VECEXP;
    };

    template <>
    struct TagOf<pair < string, vector < pair <string, string> > >>
    {
        static Tag__ const tag = Tag__::FUN_DECLARATOR;
    };

    template <>
    struct TypeOfBase<Tag__::PARAMETER_DECLARATION>
    {
        typedef pair <string, string> DataType;
    };
    ...
    template <>
    struct TypeOfBase<Tag__::DECLARATOR_LIST>
    {
    ...
    template <>
    struct TypeOfBase<Tag__::PARAMETER_LIST>
    {
        typedef vector < pair <string, string> > DataType;
    };

    template <>
    struct TypeOfBase<Tag__::SEQ>
    {
        typedef Seq* DataType;
    };
    ...
    template <>
    struct TypeOfBase<Tag__::VECEXP>
    {
        typedef vector < ExpAst* > DataType;
    };

    template <>
    struct TypeOfBase<Tag__::FUN_DECLARATOR>
    {
        typedef pair < string, vector < pair <string, string> > > DataType;
    };
